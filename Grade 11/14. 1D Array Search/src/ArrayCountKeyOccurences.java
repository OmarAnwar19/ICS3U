/* Omar Anwar
 * ICS3O, ArrayCountKeyOccurences assignment
 * 5/21/21
...
public class ArrayCountKeyOccurences {
	...
	public static void prntPrgDesc() {
		...
		System.out.println("-------------------------------------------------------------------------------------------------------");
		System.out.println("This program takes an input from the user, and returns the times of occurences of the number in an array.");
		System.out.println("-------------------------------------------------------------------------------------------------------");
	...
	public static int compUserInput(int array1 [], Scanner scanner1, int userInput) {
		...
		for ( int i = 0; i < array1.length - 1; i++ ) {
			...
			//if the array at index i = the user input, then the keyOccurrences is the same as the user input
			if (array1[i] == userInput) {

				//add to key occurrences
				keyOccurrences += 1;	
	...
	public static void displayResults(int array1[], int userInput, int keyOccurrences) {

		//print the whole array
		System.out.println("\nArray: " + Arrays.toString(array1));

		//if the keyOccurrences = -1, meaning that no value was found
		if (keyOccurrences == 0) {
			...
			//print the number, and the number of times it was found
			System.out.println("User Input: " + userInput + ". Was found: " + keyOccurrences + " time(s)");
	...
	public static void main(String[] args) {
		...
		//storing value of the key occurences by calling method for it
		int keyOccurrences = compUserInput(array1, scanner1, userInput);

		//displaying the results by calling said method
		displayResults(array1, userInput, keyOccurrences);
